...
| `shared/casino.ts` | The casino's rules: Velvet Chips 🟡 (1:1 with coins, a saved balance exchanged only at Vance's cage; `netWorth` = coins + chips for the allowance and the leaderboard; `CashierPacket`), and roulette, slots and blackjack |
